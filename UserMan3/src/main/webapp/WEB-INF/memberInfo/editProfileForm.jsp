...
<form name="fom" method="POST" action="<c:url value='/member/update' />" enctype="multipart/form-data">
	 ...
	 <div style="top: 293px; position: absolute; color: #242424; font-size: 30px; font-family: Inter; font-weight: 700; word-wrap: break-word">프로필 수정</div>
	...
	<div
		style="width: 495px; height: 79px; left: 120px; top: 370px; position: absolute">
			<div style="top: 20px; color: #505050; font-size: 26px; font-family: Inter; font-weight: 400; word-wrap: break-word">닉네임</div>
		<div
			style="width: 380px; height: 63px; bottom: 30px; left: 400px; position: absolute; background: white; border-radius: 20px; border: 1.20px #505050 solid"></div>
		<input type="text" name="nickname" value = "${memberInfo.nickname}"
			style="width: 330px; left: 420px; top: 2px; position: absolute; color: #505050; font-size: 26px; font-family: Inter; font-weight: 400; word-wrap: break-word; border: 1px solid rgba(0, 0, 0, 0);" />
	</div>
	<div
		style="width: 495px; height: 79px; left: 130px; top: 520px; position: absolute">
		<div style="left: 50px; top: 0px; color: #505050; font-size: 26px; font-family: Inter; font-weight: 400; word-wrap: break-word">비밀번호</div>
		<div
			style="width: 380px; height: 63px; left: 400px; bottom: 30px; position: absolute; background: white; border-radius: 20px; border: 1.20px #505050 solid"></div>
		<input type="password" name="password" value = "${member.password}"
			style="width: 330px; left: 420px; top: 2px; position: absolute; color: #505050; font-size: 26px; font-family: Inter; font-weight: 400; word-wrap: break-word; border: 1px solid rgba(0, 0, 0, 0);" />
	</div>
	<div
		style="width: 495px; height: 79px; left: 160px; top: 670px; position: absolute">
		<div style=" color: #505050; font-size: 26px; font-family: Inter; font-weight: 400; word-wrap: break-word">비밀번호 확인</div>
		<div
			style="width: 380px; height: 63px; left: 370px; bottom: 30px; position: absolute; background: white; border-radius: 20px; border: 1.20px #505050 solid"></div>
		<input type="password" name="password2" value = "${member.password}"
			style="width: 330px; left: 390px; top: 2px; position: absolute; color: #505050; font-size: 26px; font-family: Inter; font-weight: 400; word-wrap: break-word; border: 1px solid rgba(0, 0, 0, 0);" />
	</div>
	<div
	...
	<div style="left: 250px; top: 900px; position: absolute">
