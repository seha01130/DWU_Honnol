...
if (session != null && session.getAttribute(MemberSessionUtils.MEMBER_SESSION_KEY) != null) {
    // 세션에서 memberId를 가져옴
    loginUserId = (String)session.getAttribute(MemberSessionUtils.MEMBER_SESSION_KEY);
    System.out.println("Login Member ID: " + loginUserId);
} else {
...
$(document).ready(function() {
    ...
    console.log(memberId+ "그리고" + loginUserId);
    if(memberId != loginUserId) {
    	editProfile.type = 'hidden';
    	logout.type = 'hidden';
    	
    	editProfile_bg.style='none';
    	logout_bg.style='none';
    }
	...
	<form name="form" method="POST"
		...
		<div style="width: 1920px; height: 1080px; position: relative; background: white">
			<div id="showBothScreens" style="width: 435px; height: 930px; position: relative; background: white">
				...
				<!-- 프로필 수정 버튼 -->
				<div id="editProfile_bg" class="editProfile" id="${memberInfo.memberId}" href="#"
					...
					<input id="editProfile" class="Frame24" type="button" value="프로필 수정"
				...
				<div id="logout_bg"  style="padding-top: 13px; padding-bottom: 12px; padding-left: 51px; padding-right: 51px; left: 130px; top: 829px; position: absolute; background: #FF7C33; border-radius: 28px; overflow: hidden; border: 1px #FF7C33 solid; justify-content: center; align-items: center; display: inline-flex">
