		...
		<div
			...
			<div
				...
				<div style="width: 165px; height: 36px;">
					<input type="button" name="locationId" value='${post.locationName}'  readonly
						style="position: absolute; left: 50%; transform: translateX(-50%); top: 182px; font-size: 30px; font-weight: 300; text-align: left; padding-left: 8px; color: #6b6b6b;">
				...
				<textarea name="content" id="contentTextarea" style="padding-left: 15px; margin-top: 100px">${post.content}</textarea>
