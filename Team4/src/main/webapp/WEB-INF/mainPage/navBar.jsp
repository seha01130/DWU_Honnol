	...
	<div class="navbar">
	    ...
	    <div>
	    	<a class="logo" style="font-size: 50px; text-align: left; color: #ff7c33;" href="<c:url value='/mainPage/mainLogin'/>">
	    		<img src="${pageContext.request.contextPath}/images/HONNOL_logo.png" alt="HONNOL 로고" >
	    	</a>
	    </div>
	    ...
	    <div class="menu">
	        <div class="dropdown">
	            ...
	            <div class="dropdown-content">
	                ...
	                <a href="<c:url value='/memberInfo/myPage'/>?memberId=<%= memberId %>">내 게시글</a>
	            </div>
	        </div>
	        <!-- 
	        <div class="dropdown">
	        ...
	        <div class="dropdown">
	            <a href="#">검색</a>
	            <div class="dropdown-content">
	                <a href="<c:url value='/location/search'/>">게시글 검색</a>
	                <!--<a href="<c:url value='/map/ShowMap'/>">모임 검색</a>  -->
	            </div>
	        </div>
	        <!-- 마이페이지 버튼 -->
	        <a href="<c:url value='/memberInfo/myPage'/>?memberId=<%= memberId %>">
	            <svg
				    width="34"
				    height="34"
				    viewBox="0 0 34 34"
