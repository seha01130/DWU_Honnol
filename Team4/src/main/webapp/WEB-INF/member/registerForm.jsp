...
<form name="form" method="POST" action="<c:url value='/member/register' />" style="width: 1920px; height: 1080px; position: relative;  background: #fff;" onsubmit="return existUser()">
