...
public class MemberDAO {
	...
	public List<Post> getBookmarkList(String memberId) throws SQLException {
		List<Post> bookmarks = new ArrayList<>();
		String sql = "SELECT P.postId, P.isPublic, P.createDate, P.title, P.image, P.content, P.memberId "
			    + "FROM Post P INNER JOIN Bookmark B ON P.postId = B.postId "
			    + "WHERE B.memberId = ?";
