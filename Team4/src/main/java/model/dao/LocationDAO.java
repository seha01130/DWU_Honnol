...
public class LocationDAO {
     ...
     */
    public int getLocationId(String address) throws SQLException {
    	String query = "SELECT locationId FROM Location WHERE TRIM(address) = TRIM(?)";
    	Object[] param = new Object[]{address};
        jdbcUtil.setSqlAndParameters(query, param);
        System.out.println("주소다~" + address);
