...
public class Post {
    ...
    public Post(int postId, int isPublic, Date createDate, String title, String image, String content, String memberId,
            int locationId, String locationName, String locationAddress, int myBookmarks, String nickname,
    ...
    public Post(int postId, String title, String image, String content) {
        super();
        this.postId = postId;
        this.title = title;
        this.image = image;
