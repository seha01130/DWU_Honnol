...
public class MemberManager {
	...
	public List<Post> getBookmarkList(String memberId) throws SQLException, MemberNotFoundException {
		List<Post> memberBookmarks = memberDAO.getBookmarkList(memberId);
