...
//		}
	...
	public MemberInfo findMemberInfoByNickname(String nickname) throws SQLException {
		return memberInfoDAO.findProfileByNickname(nickname);
	}
	public MemberInfo findMemberInfoById(String memberId) throws SQLException {
		return memberInfoDAO.findProfileById(memberId);
	}
